...
public class SoumyaKakarlapudi extends Student implements SpecialInterestOrHobby
{
    ...
    public SoumyaKakarlapudi() {
     ...
     /**
     * Act - do whatever the SoumyaKakarlapudi actor wants to do. This method is called whenever
    ...
    public void answerQuestion(){
        ...
        if (q.contains("hard")){
            q=Greenfoot.ask("2D arrays, recursion, and merge sort... Would you like to know more about these subjects?");
            if(q.contains("yes")){
                q=Greenfoot.ask("Which one would you like to know about?");
    ...
    /**
     * This is a local method specific to the SoumyaKakarlapudi class used to animate the character once the image is clicked on.
