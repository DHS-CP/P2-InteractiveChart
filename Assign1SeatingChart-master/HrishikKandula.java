...
/**
 * The HrishikKandula class can be used as a model for your own class that represents you and your seating location in AP CSA
 * 
 * @author Mr. Kaehms
...
public class HrishikKandula extends Student implements SpecialInterestOrHobby, NumberOfSiblings
{
    ...
    public HrishikKandula() {
     ...
     /**
     * Act - do whatever the HrishikKandula actor wants to do. This method is called whenever
